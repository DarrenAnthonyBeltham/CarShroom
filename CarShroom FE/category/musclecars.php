...
<head>
    ...
    <title>Muscle Car Collection - CarShroom</title>
...
<body>
    ...
    <?php 
        ...
        $muscle_cars = [
            [
                ...
                'description' => 'The definitive modern muscle car, blending retro styling with raw supercharged V8 power for an unmatched straight-line experience.',
                'image' => 'assets/musclecars/DodgeChallengerSRTHellcatRedeye.jpg',
                'specs' => [
                    'HP' => '797',
                    '0-60' => '~3.4s',
                    'Top Speed' => '203 mph'
            ...
            [
                ...
                'brand' => 'Chevrolet',
                'name' => 'Camaro ZL1',
                'description' => 'The track-ready halo of the Camaro lineup, delivering blistering acceleration and superb handling thanks to its extensive aerodynamic enhancements.',
                'image' => 'assets/musclecars/ChevroletCamaroZL1.jpg',
                'specs' => [
                    'HP' => '650',
                    '0-60' => '~3.5s',
                    'Top Speed' => '198 mph'
            ...
            [
                ...
                'description' => 'The most powerful street-legal Mustang ever, featuring a dual-clutch transmission and carbon fiber components for track-day dominance.',
                'image' => 'assets/musclecars/FordMustangGT500.webp',
                'specs' => [
                    'HP' => '760',
                    '0-60' => '~3.3s',
                    'Top Speed' => '180 mph'
    ...
    <nav class="side-navigation" id="sideNav">
        <?php foreach($muscle_cars as $car): ?>
