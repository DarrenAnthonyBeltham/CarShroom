...
$cars = [
    [
        'image' => '../assets/Dodge-Challenger-SRT.jpg',
        'title' => 'Dodge Challenger SRT',
        'description' => 'The Dodge Challenger SRT is a modern American muscle car powered by a supercharged 6.2-liter HEMI® V8 engine producing up to 797 horsepower (in the Hellcat Redeye), featuring launch control, adaptive dampers, and Brembo® brakes for raw straight-line performance and classic retro styling.',
        'alt_text' => 'Dodge Challenger SRT'
    ],
    [
        'image' => '../assets/Chevrolet Camaro ZR1.jpg',
        'title' => 'Chevrolet Camaro ZR1',
        'description' => 'The Chevrolet Camaro ZR1 is the track-ready halo of the Camaro lineup, equipped with a 6.2-liter supercharged LT4 V8 producing 755 horsepower, magnetic ride control suspension, carbon-ceramic brakes, and extensive aerodynamic enhancements to deliver superb handling and blistering acceleration.',
        'alt_text' => 'Chevrolet Camaro ZR1'
    ],
    [
        'image' => '../assets/ford mustang shelby gt500.jpg',
        'title' => 'Ford Mustang Shelby GT500',
        'description' => 'The Ford Mustang Shelby GT500 is the most powerful street-legal Mustang ever, featuring a 5.2-liter supercharged V8 engine making 760 horsepower, a dual-clutch transmission, MagneRide® Damping System, and carbon fiber wheels for exceptional cornering, braking, and track performance.',
        'alt_text' => 'Ford Mustang Shelby GT500'
    ]
];
?>
<!DOCTYPE html>
