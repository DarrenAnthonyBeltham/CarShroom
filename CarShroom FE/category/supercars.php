...
$cars = [
    [
        ...
        'description' => 'The BMW M4 Competition is a high-performance coupe powered by a 3.0-liter twin-turbo inline-six engine producing 503 horsepower and 479 lb-ft of torque, featuring adaptive M suspension and lightweight carbon-fiber components for track-ready handling.',
        'alt_text' => 'BMW M4 Competition'
    ],
    [
        'image' => '../assets/Maserati GranTurismo.jpg',
        'title' => 'Maserati GranTurismo',
        'description' => 'The Maserati GranTurismo is a luxurious grand tourer equipped with a 4.7-liter V8 engine delivering around 454 horsepower, combining elegant Italian styling, handcrafted leather interiors, and a sonorous exhaust note for effortless long-distance cruising.',
        'alt_text' => 'Maserati GranTurismo'
    ],
    [
        'image' => '../assets/Mclaren-570s.jpg',
        'title' => 'McLaren 570S',
        'description' => 'The McLaren 570S is a mid-engine sports car from McLaren’s Sports Series, featuring a 3.8-liter twin-turbo V8 that produces 562 horsepower, a carbon fiber MonoCell chassis, and race-inspired aerodynamics for exhilarating performance and driver engagement.',
        'alt_text' => 'McLaren 570S'
    ]
];
?>
<!DOCTYPE html>
